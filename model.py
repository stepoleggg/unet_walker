...
def unet(num_channels, pretrained_weights = None, input_size = (256,256,3)):
    ...
    drop4 = Dropout(0.5)(conv4) #а нужен ли дропаут?
    ...
    conv10 = Conv2D(num_channels, 1, activation = 'sigmoid')(conv9)
